/** 
		...
		Переробити програму, щоб використовувалася функція для обчислення результату.
		Завдання №23 (Чи є задане число простим) тема: Циклічні конструкції
...
/**
	 ...
	 *
	 * @param true=0 перша змінна 
	 * @param false=1 друга змінна
	 * @param int isPrime(int x) функція, яка перевіряє чи х просте число 
	 */
